...
public class DoubleLinkedListDriver extends Application {
	...
	// Add a flag to track whether the iterator has been started
	...
	private class ButtonEventHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
			...
			//Retrieve first button (deletes from list)
			else if (e.getSource() == retrieveFirst) {
				String retrieved;
				if(basicDLL.isSelected()){
					...
					result = basic.toArrayList();
					showLists("basic",result);
					System.out.println("Retrieve First (Basic): " + retrieved);
				}
				else {
					...
					result = sorted.toArrayList();
					showLists("sorted",result);
					System.out.println("Retrieve First (Sorted): " + retrieved);
				}
			}
			...
			if (e.getSource() == retrieveLast) {
				...
				if(basicDLL.isSelected()){
					...
					result = basic.toArrayList();
					showLists("basic",result);
					System.out.println("Retrieve Last (basic): " + retrieved);
				}
				else {
					...
					result = sorted.toArrayList();
					showLists("sorted",result);
					System.out.println("Retrieve Last (Sorted): " + retrieved);
				}	
			}
			...
			if (e.getSource() == getFirst) {
				...
				if(basicDLL.isSelected()){
					...
					result = basic.toArrayList();
					showLists("basic",result);
					System.out.println("Get First (basic): " + retrieved);
				}
				else {
					...
					result = sorted.toArrayList();
					showLists("sorted",result);
					System.out.println("Get First (Sorted): " + retrieved);
				}		
			}	
			...
			//Get last button (does not delete from list)
				...
				if(basicDLL.isSelected()){
					...
					result = basic.toArrayList();
					showLists("basic",result);
					System.out.println("Get Last (Basic): " + retrieved);
				}
				else {
					...
					getElementField.setText(retrieved);
					showLists("sorted",result);
					System.out.println("Get Last (Sorted): " + retrieved);
				}	
			} 
			...
			if (e.getSource() == remove) {
			    ...
			    String removedElement = null; // Variable to store the removed element
			    if (basicDLL.isSelected()) {
			        boolean removed = basic.remove(newElement, sComp);
			        if (removed) {
			            removedElement = newElement;
			        }
			        result = basic.toArrayList();
			        showLists("basic", result);
			    } else {
			        boolean removed = sorted.remove(newElement, sComp);
			        if (removed) {
			            removedElement = newElement;
			        }
			        result = sorted.toArrayList();
			    ...
			    // Print the removed element to the console
			    if (removedElement != null) {
			        System.out.println("Removed Element: " + removedElement);
			    } else {
			        System.out.println("Element not found or list is empty.");
			    }
			}
            ...
            if (e.getSource() == hasNext) {
                boolean answer;
                if (!iteratorStarted) {
                    System.out.println("Please start the iterator first.");
                    return;
                }
                ...
                if (basicDLL.isSelected()) {
                    ...
                    result = basic.toArrayList();
                    showLists("basic", result);
                    System.out.println("Has Next (Basic): " + answer);
                } else {
                    answer = sortedIter.hasNext();
                    result = sorted.toArrayList();
                    showLists("sorted", result);
                    System.out.println("Has Next (Sorted): " + answer);
                }
                if (answer)
            ...
            if (e.getSource() == hasPrev) {
                ...
                if (basicDLL.isSelected()) {
                    ...
                    result = basic.toArrayList();
                    showLists("basic", result);
                    System.out.println("Has Previous (Basic): " + answer);
                } else {
                    answer = sortedIter.hasPrevious();
                    result = sorted.toArrayList();
                    showLists("sorted", result);
                    System.out.println("Has Previous (Sorted): " + answer);
                }
                if (answer)
                    iteratorField.setText("true");
                else
			...
			if (e.getSource() == startIterator) {
				if(basicDLL.isSelected()){
					...
					basicIterCount = 0;
					iteratorStarted = true; // Set the flag to true when starting the iterator
					 System.out.println("Starting Iterator... (Basic)");
				}
				else {
					...
					sortedIterCount = 0;
					iteratorStarted = true; // Set the flag to true when starting the iterator
					System.out.println("Starting Iterator... (Sorted)");
				}		
			} 
            ...
            if (e.getSource() == prev) {
                ...
                try {
                    ...
                    System.out.println("Previous button pressed successfully");
                } catch (NoSuchElementException ex) {
                    alertUser.setHeaderText(null);
	...
	public void start(Stage stage) {
		...
		Scene scene = new Scene(mainPane, 550, 700);
