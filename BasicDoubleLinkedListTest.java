...
public class BasicDoubleLinkedListTest {
	...
	public void testIteratorSuccessfulPrevious() {
	    BasicDoubleLinkedList<Car> linkedCar = new BasicDoubleLinkedList<Car>();
	    linkedCar.addToFront(a);
	    linkedCar.addToEnd(b);
	    linkedCar.addToEnd(c);
	    linkedCar.addToEnd(d);
	...
	public void testIteratorNoSuchElementExceptionPrevious() {
	    ...
	    assertFalse(iteratorCar.hasNext());
	    ...
	    try {
	        // Attempting to move to the previous element again should throw NoSuchElementException
	        iteratorCar.previous();
	...
	public void testIteratorUnsupportedOperationException() {
		...
		try{
			...
			iteratorCar.remove();
			assertFalse("Did not throw a UnsupportedOperationException",false);
		}
